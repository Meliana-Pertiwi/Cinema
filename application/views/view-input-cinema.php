...
<body>
    ...
    <form action="<?= base_url ('addCinema') ?>" method="POST">
    ...
    Judul Film   : <select name="judul" id="">
                        ...
                        <option value="Kamen Ryder Reiwa">Kamen Ryder Reiwa</option>
                  </select><br>
    Pukul : <input type="radio" name="pukul" value="14.20">14.20 <input type="radio" name="pukuul" value="15.40">15.40 <input type="radio" name="pukul" value=16.40>16.40 <br>
